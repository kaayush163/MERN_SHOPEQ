...
function AdminProducts() {
  ...
  function onSubmit(event) {
    ...
    // on edit and subbmit the display will shwo the updated details of Product
    currentEditedId !== null
      ? dispatch(
          // passing same parameters where this edit Product defined on creating its createAsyncThunk
          editProduct({
            id: currentEditedId,
            formData,
          })
